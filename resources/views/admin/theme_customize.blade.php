...
@section('content')
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
        ...
        <div class="col-span-1  bg-white p-6 rounded shadow" x-data="themeCustomizer()" @input.debounce.500="previewChanges">
            <h2 class="text-xl font-semibold mb-4">Customize Theme: <span class="capitalize">{{ getActiveTheme() }}</span>
            </h2>
            ...
            <form method="POST" action="{{ route('themes.customize.update') }}" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <input type="color" name="primary_color" x-model="primaryColor"
                        value="{{ $settings->primary_color ?? '#0d6efd' }}" class="w-24 h-10 border-2 rounded">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="footer_text" x-model="footerText" value="{{ $settings->footer_text }}"
                ...
                <div class="flex flex-col gap-2">
                    <button type="submit" class="bg-green-600 text-white px-4 py-2 rounded">Save
                        Settings</button>
            ...
            <div class="mt-6">
                <div class="flex flex-col gap-2">
                    ...
                    <a href="{{ route('themes.customize.export') }}"
                        class="text-sm text-white  inline-block bg-green-700  px-4 py-2 rounded">Download
                        Current Settings (JSON)
                    </a> --}}
                    <form method="POST" class="flex flex-col gap-2" action="{{ route('themes.customize.reset') }}"
