...
@section('content')
    <div class="max-w-6xl mx-auto space-y-6 " x-data="pagesTable()" x-init="currentPage = 1">
        {{-- Header --}}
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                ...
                <div class="flex justify-end">
                    <button @click="resetFilters()" type="button"
                        class="border px-4 py-2 rounded hover:bg-gray-100">Reset</button>
                </div>
            </div>
        </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                         ...
                         .toLocaleDateString('en-US',
                           {month:'short',day:'numeric',year:'numeric'})">
                            ...
                            <td class="p-2 text-right space-x-2">
                                ...
                                <!-- Edit in the admin -->
                                <a :href="`/admin/pages/${page.id}/edit`" class="text-indigo-600 hover:underline">Edit</a>
                    ...
                    <template x-if="filteredData().length === 0">
                        <tr>
                            <td colspan="6" class="p-4 text-center text-gray-500">No pages found.</td>
                        </tr>
                    </template>
                </tbody>
            </table>
                ...
                return {
                    ...
                    filteredData() {
                        return this.posts.filter(p => {
                            const matchSearch = !this.search || p.title.toLowerCase().includes(this.search
                                .toLowerCase());
